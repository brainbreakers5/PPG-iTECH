                        ...
                        {filteredPersonnel.map((member, idx) => (
                            ...
                            >
                                ...
                                <div className="mt-4 flex items-center gap-3">
                                    <span className="px-4 py-1.5 rounded-full bg-sky-50 text-sky-600 border border-sky-100 text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
                                        <FaIdBadge /> {member.emp_id}
                                    </span>
                                </div>
                                ...
                                <div className="w-full mt-8 grid grid-cols-1 gap-4">
                                    <div className="p-5 rounded-[30px] bg-gray-50/50 border border-transparent hover:border-sky-50 hover:bg-white transition-all group/item flex flex-col items-center">
                                        <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1">{member.department_name || "Institutional Department"}</p>
                                        <p className="text-xs font-black text-gray-800 tracking-tight group-hover/item:text-sky-600 transition-colors uppercase">Primary Placement</p>
                                    </div>
                                </div>
