...
const SalaryManagement = () => {
    ...
    const [paidStatuses, setPaidStatuses] = useState(['Present', 'CL', 'ML', 'Comp Leave', 'OD', 'Leave', 'Holiday', 'Weekend']);

    const attendanceOptions = ['Present', 'OD', 'CL', 'ML', 'Comp Leave', 'Leave', 'Holiday', 'Weekend', 'Absent', 'LOP'];
                            ...
                            <div className="mt-12 pt-10 border-t border-gray-100">
                                ...
                                <div className="grid grid-cols-1 gap-3">
                                    {attendanceOptions.map(status => (
                                        <label
                                            key={status}
                                            className={`flex items-center gap-4 p-4 rounded-2xl cursor-pointer transition-all border ${paidStatuses.includes(status)
                                ...
                                <p className="text-[9px] font-bold text-gray-400 uppercase mt-6 leading-relaxed bg-amber-50 p-4 rounded-xl border border-amber-100 italic">
                                    Selected statuses will count as 100% paid days. LOP is excluded.
                                </p>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <td className="p-8">
                                                            <div className="flex flex-col items-center gap-3">
                                                                <div className="flex gap-4 text-[9px] font-black uppercase tracking-widest">
                                                                    ...
                                                                    <span className="text-rose-500 bg-rose-50 px-2 py-1 rounded-md">LOP: {s.total_lop}</span>
                                                                </div>
